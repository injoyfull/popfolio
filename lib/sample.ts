...
// 일곱 살 '쪼이'의 실제 활동 사진(찰흙·로봇·쿠키·실공예·양털·클레이 정원·낚시놀이·배드민턴)
...
export const SAMPLE_PORTFOLIO: Portfolio = {
  ...
  items: [
    ...
    {
      id: "im_5",
      image: "/sample/joy-doodle-house.svg",
      title: "우리 집",
      date: "2024-09-05",
    ...
    {
      id: "im_6",
      image: "/sample/joy-doodle-bike.svg",
      title: "씽씽 자전거",
      date: "2024-07-21",
    ...
    {
      id: "im_7",
      image: "/sample/joy-doodle-rocket.svg",
      title: "출발, 로켓!",
      date: "2026-03-11",
