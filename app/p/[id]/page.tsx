...
export default async function PortfolioPage({
  ...
  const { mood, style, k, created } = await searchParams;
  ...
  const withMood =
    mood && mood in MOODS
      ...
      : publicPortfolio;
  const portfolio =
    style && hasStyle(style) ? { ...withMood, style } : withMood;
